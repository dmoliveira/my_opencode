...
- Added cross-cutting epic acceptance criteria template in `IMPLEMENTATION_ROADMAP.md` (Task C2) with measurable gates for functionality, reliability, docs, validation, evidence, and rollback.
