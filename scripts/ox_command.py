...
COMMAND_SPECS: dict[str, dict[str, Any]] = {
    ...
    "review": {
        ...
        "summary": "Review the selected code path end to end, then improve correctness, maintainability, tests, docs, and ship readiness in one bounded pass.",
        "agent": "orchestrator",
        ...
        "workflow": [
            ...
            "Identify correctness, maintainability, test, docs, and migration risks.",
        ...
        "defaults": {
            "goal": "Review this code end to end, improve the weak spots pragmatically, and leave it cleaner, safer, and easier to maintain.",
            "scope": "current branch diff or selected feature area",
            "focus": [
                "correctness",
                "maintainability",
                "tests",
