...
export type PatternWorkerOperation =
  | PatternWorkerApplyOperation
  | PatternWorkerMatchOperation
  | PatternWorkerAttachmentOperation
...
export type PatternWorkerResult =
