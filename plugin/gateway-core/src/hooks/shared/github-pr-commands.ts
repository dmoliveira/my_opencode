...
function hasOpaqueShellPrCreateIntent(command: string): boolean {
...
function hasSynchronizedRemoteHead(worktree: string, branch: string): boolean {
  try {
