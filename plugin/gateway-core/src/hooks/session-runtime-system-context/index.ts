...
function candidateSkillPaths(directory: string): string[] {
...
function loadConciseSkillBody(directory: string): string {
...
function buildConciseModeContext(directory: string, mode: string, source: string): string {
  return [
