...
function latestRunningStateForLink(args: {
  ...
  link: { parentSessionId: string; childRunId?: string; traceId?: string; subagentType?: string }
...
function inspectChildMessageState(messages: Array<{
  info?: { role?: string; error?: unknown; time?: { completed?: number } }
  parts?: Array<{ type?: string; text?: string; synthetic?: boolean }>
}>): "completed" | "failed" | "active" | "unknown" {
