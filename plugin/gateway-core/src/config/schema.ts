...
// Declares notification hook settings for completion/error/question events.
...
// Declares mistake ledger settings for structured assistant mistake capture.
