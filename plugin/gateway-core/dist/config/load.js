...
function configuredRedactionToken(value, fallback) {
    if (typeof value !== "string") {
        return fallback;
    }
    if (value.length > MAX_REDACTION_TOKEN_BYTES ||
...
function gatewayConfigLayerPaths(directory) {
...
export function loadGatewayConfigSourceWithMeta(directory, source, override) {
    ...
    for (const layer of gatewayConfigLayerPaths(directory)) {
        ...
        if (meta.exists) {
            try {
                const parsed = JSON.parse(readFileSync(layer.path, "utf-8"));
                if (isRecord(parsed)) {
    ...
    const effectiveLayer = [...layers].reverse().find((layer) => layer.exists) ?? layers.at(-1);
...
function severityOperator(value, fallback) {
...
function durationThreshold(value, fallback) {
    if (typeof value !== "string") {
        return fallback;
    }
...
export function loadGatewayConfig(raw) {
    ...
    const tasksTodowriteSource = source.tasksTodowriteDisabler &&
        ...
        : {};
    const assistantMessageTimestampSource = source.assistantMessageTimestamp &&
    ...
    const codememoryMilestoneBridgeSource = source.codememoryMilestoneBridge &&
        ...
        : {};
    const intentIngressOutboxSource = source.intentIngressOutbox && typeof source.intentIngressOutbox === "object"
        ? source.intentIngressOutbox
        : {};
    ...
    const scopeDriftSource = source.scopeDriftGuard && typeof source.scopeDriftGuard === "object"
        ? source.scopeDriftGuard
        : {};
    const doneProofSource = source.doneProofEnforcer && typeof source.doneProofEnforcer === "object"
        ? source.doneProofEnforcer
        : {};
    const dependencyRiskSource = source.dependencyRiskGuard && typeof source.dependencyRiskGuard === "object"
        ? source.dependencyRiskGuard
        : {};
    const docsDriftSource = source.docsDriftGuard && typeof source.docsDriftGuard === "object"
        ? source.docsDriftGuard
        : {};
    const hookTestParitySource = source.hookTestParityGuard && typeof source.hookTestParityGuard === "object"
        ? source.hookTestParityGuard
        : {};
    ...
    return {
        ...
        autopilotLoop: {
            ...
            maxIgnoredCompletionCycles: positiveInt(autopilotSource.maxIgnoredCompletionCycles, DEFAULT_GATEWAY_CONFIG.autopilotLoop.maxIgnoredCompletionCycles),
            completionMode,
        ...
        globalProcessPressure: {
            ...
            selfSeverityOperator: severityOperator(globalProcessPressureSource.selfSeverityOperator, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfSeverityOperator),
            selfHighCpuPct: nonNegativeInt(globalProcessPressureSource.selfHighCpuPct, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfHighCpuPct),
            selfHighRssMb: nonNegativeInt(globalProcessPressureSource.selfHighRssMb, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfHighRssMb),
            selfHighElapsed: durationThreshold(globalProcessPressureSource.selfHighElapsed, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfHighElapsed),
            selfHighLabel: nonEmptyLabel(globalProcessPressureSource.selfHighLabel, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfHighLabel),
            selfLowLabel: nonEmptyLabel(globalProcessPressureSource.selfLowLabel, DEFAULT_GATEWAY_CONFIG.globalProcessPressure.selfLowLabel),
        ...
        adaptiveDelegationPolicy: {
            ...
            outcomeLearnerMode: outcomeLearnerMode(adaptiveDelegationPolicySource.outcomeLearnerMode, DEFAULT_GATEWAY_CONFIG.adaptiveDelegationPolicy.outcomeLearnerMode),
        ...
        llmDecisionRuntime: {
            enabled: typeof llmDecisionRuntimeSource.enabled === "boolean"
            ...
            model: typeof llmDecisionRuntimeSource.model === "string" &&
            ...
            cacheTtlMs: positiveInt(llmDecisionRuntimeSource.cacheTtlMs, DEFAULT_GATEWAY_CONFIG.llmDecisionRuntime.cacheTtlMs),
            maxCacheEntries: positiveInt(llmDecisionRuntimeSource.maxCacheEntries, DEFAULT_GATEWAY_CONFIG.llmDecisionRuntime.maxCacheEntries),
        },
        ...
        readBudgetOptimizer: {
            enabled: typeof readBudgetOptimizerSource.enabled === "boolean"
                ? readBudgetOptimizerSource.enabled
                : DEFAULT_GATEWAY_CONFIG.readBudgetOptimizer.enabled,
            smallReadLimit: nonNegativeInt(readBudgetOptimizerSource.smallReadLimit, DEFAULT_GATEWAY_CONFIG.readBudgetOptimizer.smallReadLimit),
            maxConsecutiveSmallReads: nonNegativeInt(readBudgetOptimizerSource.maxConsecutiveSmallReads, DEFAULT_GATEWAY_CONFIG.readBudgetOptimizer.maxConsecutiveSmallReads),
        },
        ...
        directoryAgentsInjector: {
            ...
            maxChars: positiveInt(directoryAgentsSource.maxChars, DEFAULT_GATEWAY_CONFIG.directoryAgentsInjector.maxChars),
        },
        ...
        agentReservationGuard: {
            enabled: typeof agentReservationSource.enabled === "boolean"
                ? agentReservationSource.enabled
                : DEFAULT_GATEWAY_CONFIG.agentReservationGuard.enabled,
            enforce: typeof agentReservationSource.enforce === "boolean"
        ...
        assistantMessageTimestamp: {
            enabled: typeof assistantMessageTimestampSource.enabled === "boolean"
        ...
        intentIngressOutbox: {
            enabled: typeof intentIngressOutboxSource.enabled === "boolean"
                ? intentIngressOutboxSource.enabled
                : DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.enabled,
            captureContent: typeof intentIngressOutboxSource.captureContent === "boolean"
                ? intentIngressOutboxSource.captureContent
                : DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.captureContent,
            stateDir: typeof intentIngressOutboxSource.stateDir === "string" &&
                intentIngressOutboxSource.stateDir.trim()
                ? intentIngressOutboxSource.stateDir.trim()
                : DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.stateDir,
            maxInputChars: boundedInteger(intentIngressOutboxSource.maxInputChars, 1, 1_048_576, DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.maxInputChars),
            maxContentChars: boundedInteger(intentIngressOutboxSource.maxContentChars, 1, 65_536, DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.maxContentChars),
            maxEnvelopeBytes: boundedInteger(intentIngressOutboxSource.maxEnvelopeBytes, 512, 262_144, DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.maxEnvelopeBytes),
            softMaxPendingEntries: boundedInteger(intentIngressOutboxSource.softMaxPendingEntries, 1, 10_000, DEFAULT_GATEWAY_CONFIG.intentIngressOutbox.softMaxPendingEntries),
        },
        ...
        editErrorRecovery: {
            enabled: typeof editErrorRecoverySource.enabled === "boolean"
        ...
        secretLeakGuard: {
            ...
            redactionToken: configuredRedactionToken(secretLeakSource.redactionToken, DEFAULT_GATEWAY_CONFIG.secretLeakGuard.redactionToken),
        ...
        prReadinessGuard: {
            ...
            requireCleanWorktree: typeof prReadinessSource.requireCleanWorktree === "boolean"
                ? prReadinessSource.requireCleanWorktree
                : DEFAULT_GATEWAY_CONFIG.prReadinessGuard.requireCleanWorktree,
            requireValidationEvidence: typeof prReadinessSource.requireValidationEvidence === "boolean"
        ...
        mergeReadinessGuard: {
            ...
            requireDeleteBranch: typeof mergeReadinessSource.requireDeleteBranch === "boolean"
                ? mergeReadinessSource.requireDeleteBranch
                : DEFAULT_GATEWAY_CONFIG.mergeReadinessGuard.requireDeleteBranch,
            requireStrategy: typeof mergeReadinessSource.requireStrategy === "boolean"
