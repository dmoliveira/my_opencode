import { captureGitStateFingerprint, type GitStateFingerprint, sameGitState } from "./git-state.js";
...
export declare function validationEvidence(sessionId: string, directory?: string): ValidationEvidenceSnapshot;
export declare function worktreeValidationEvidence(directory: string): ValidationEvidenceSnapshot;
export declare function markValidationEvidence(sessionId: string, categories: ValidationEvidenceCategory[], directory?: string, expectedFingerprint?: GitStateFingerprint): ValidationEvidenceSnapshot;
export declare function clearValidationEvidence(sessionId: string): void;
export declare function missingValidationMarkers(sessionId: string, markers: string[], directory?: string): string[];
