const THINKING_WARNING = "[thinking validator] Detected malformed thinking block. Ensure every <thinking> has a matching </thinking>.";
// Returns true when text has malformed <thinking> tag ordering.
function hasMalformedThinkingBlocks(text) {
...
export function createThinkingBlockValidatorHook(options) {
    return {
