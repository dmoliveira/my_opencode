...
function isOwnedByCurrentUser(value) {
...
export function executionStatusPath(directory) {
...
export async function readExecutionStatus(directory) {
    ...
    try {
        ...
        if (!isPrivateStateDirectory(directoryAfter) ||
...
export function statusForSession(snapshot, sessionId, now = Date.now()) {
