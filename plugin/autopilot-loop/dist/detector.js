...
export function detectPromiseCompletion(text, promise) {
    if (!text.trim()) {
        return false;
    }
...
export function detectObjectiveCompletionSignal(text) {
...
export function detectCompletion(state, assistantText) {
