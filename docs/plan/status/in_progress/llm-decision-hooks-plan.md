...
| Epic 5 - Prompt and protocol hardening | in_progress | Single-char contract, parser tests, prompt refinements, refusal rejection, untrusted-context serialization, and stronger adversarial phrase neutralization are in place; broader adversarial expansion remains open. |
