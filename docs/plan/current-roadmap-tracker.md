...
| LLM decision hooks planning | doing | Active plan lives under `docs/plan/status/in_progress/llm-decision-hooks-plan.md`; current checkpoint now includes disagreement aggregation, rollout recommendation reporting, and markdown artifact generation for AI-assisted hooks. |
