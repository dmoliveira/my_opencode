...
- [ ] Add auto-expire scheduler integration into daemon loop
...
- [ ] Add optional real command execution backend for step actions
- [ ] Add DAG/dependency-aware step ordering
