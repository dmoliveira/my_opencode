...
- [x] Create one feature branch per epic (`feat/v0-9-<epic-slug>`)
- [x] Implement scoped changes (command/runtime + docs + selftest)
- [x] Run full validation gates
- [x] Commit with concise why-focused message
- [x] Push branch + open PR
- [x] Merge PR and return to clean `main`
- [x] Update this plan worklog and epic checkboxes
