...
- [ ] Add profile model (`off|balanced|strict`) for risky mutations
- [ ] Gate execute/close/drain operations when strict policy blocks
- [ ] Add override path and clear reason codes
