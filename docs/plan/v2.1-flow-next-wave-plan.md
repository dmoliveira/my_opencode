...
- [ ] Add reusable release-train profile presets for docs-only and runtime releases
- [ ] Add selftest coverage for profile-driven publish planning behavior
- [ ] Document profile selection guidance in runbook/handbook
