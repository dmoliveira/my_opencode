...
docs-automation-summary-update: ## Regenerate docs automation summary artifact
	python3 scripts/update_docs_automation_summary.py
...
gateway-status: ## Show gateway plugin status
	python3 scripts/gateway_command.py status --json

gateway-enable: ## Enable gateway plugin file entry
	python3 scripts/gateway_command.py enable --json

gateway-disable: ## Disable gateway plugin file entry
	python3 scripts/gateway_command.py disable --json
...
install-test: ## Run installer smoke test in temp HOME
	...
	if [ -f "$$TMP_HOME/.config/opencode/my_opencode/scripts/tmux_command.py" ]; then HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/tmux_command.py" status --json; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/tmux_command.py" config enabled true; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/tmux_command.py" doctor --json; fi; \
	if [ -f "$$TMP_HOME/.config/opencode/my_opencode/scripts/my_opencode_cli.py" ]; then HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/my_opencode_cli.py" version; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/my_opencode_cli.py" doctor --json; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/my_opencode_cli.py" install --repo-url "$(PWD)" --repo-ref "$$(git rev-parse --abbrev-ref HEAD)" --install-dir "$$TMP_HOME/.config/opencode/my_opencode-cli-test" --dry-run; fi; \
	...
	if [ -f "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" ]; then TASK_ID=$$(HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" create --subject "install test task" --owner install-test --json | python3 -c 'import json,sys; print((json.load(sys.stdin).get("task") or {}).get("id") or "")'); HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" list --json; if [ -n "$$TASK_ID" ]; then HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" update "$$TASK_ID" --status completed --json; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" ready --json; fi; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/task_graph_command.py" doctor --json; fi; \
	...
	if [ -f "$$TMP_HOME/.config/opencode/my_opencode/scripts/model_routing_command.py" ]; then HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/model_routing_command.py" status --json; HOME="$$TMP_HOME" python3 "$$TMP_HOME/.config/opencode/my_opencode/scripts/model_routing_command.py" resolve --category deep --override-model openai/nonexistent --available-models openai/gpt-5.1-codex-mini,openai/gpt-5.3-codex --json; fi; \
